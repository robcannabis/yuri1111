...
client.on('ready', async () => {
 ...
 const num = parseFloat((Math.random() * 0.2 + 0.1 + Number.EPSILON).toFixed(1));
  ...
  setInterval(() => {
    ...
    const change = ['https://cdn.discordapp.com/attachments/874513281736384522/1231094416660500520/xvavaa.png?ex=6635b505&is=66234005&hm=24e23e79eab2d831236734c22348027c45430af82e4691d7111f44a8fc622c13&']; //รูปใหญ่
   ...
   const iooi = ['Music 1']; // ชื่อ button 2
   const iiio = ['https://www.youtube.com/watch?v=qguo-j5PxBE']; // ลิ้ง button 2
